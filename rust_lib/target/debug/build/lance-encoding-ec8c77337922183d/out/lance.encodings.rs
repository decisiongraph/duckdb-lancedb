...
impl ::prost::Name for PackedStructFixedWidthMiniBlock {
    const NAME: &'static str = "PackedStructFixedWidthMiniBlock";
    const PACKAGE: &'static str = "lance.encodings";
    fn full_name() -> ::prost::alloc::string::String {
        "lance.encodings.PackedStructFixedWidthMiniBlock".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/lance.encodings.PackedStructFixedWidthMiniBlock".into()
    }
...
pub struct FullZipLayout {
    ...
    pub value_compression: ::core::option::Option<ArrayEncoding>,
    /// The meaning of each repdef layer, used to interpret repdef buffers correctly
    #[prost(enumeration = "RepDefLayer", repeated, tag = "4")]
    pub layers: ::prost::alloc::vec::Vec<i32>,
}
